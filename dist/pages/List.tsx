    ...
    <>
      ...
      <ScrollView
        ...
        <TouchableOpacity
          ...
          <Image
            source={{
              uri: 'https://i0.wp.com/www.infobudaya.net/wp-content/uploads/2017/09/seren-taun-cipta-gelar006.jpg?resize=360%2C235&ssl=1',
            }}
            style={{
              width: 130,
              height: 100,
          ...
          <View>
            ...
            <View
              ...
              <FontAwesome5Icon name="map-marked-alt" style={{color: '#444'}} />
              <Text style={{color: '#444'}}>Cigugur, Kuningan</Text>
            </View>
          </View>
          <TouchableOpacity
            onPress={() => {}}
